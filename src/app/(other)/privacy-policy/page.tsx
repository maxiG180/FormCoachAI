...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl text-gray-300">
      <h1 className="text-4xl font-bold mb-8 text-[#FF6500]">Privacy Policy</h1>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Welcome to FormCoachAI. We are committed to protecting your privacy
        ...
        <p className="mb-4">
          By accessing or using FormCoachAI, you agree to the collection and use
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            ...
            provide in your profile, such as your fitness goals, experience
            level, or personal preferences.
          </li>
          <li>
            <strong>Content</strong>: Information you provide when uploading
            videos for analysis, including exercise form videos and related
            metadata.
          </li>
          <li>
            <strong>Communications</strong>: If you contact us directly, we may
            receive additional personal information about you, such as your
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            ...
            you use to access our services, including hardware model, operating
            system, unique device identifiers, and mobile network information.
          </li>
          <li>
            <strong>Log Information</strong>: Log data such as your IP address,
            browser type, access times, pages viewed, and the page you visited
            before navigating to our service.
          </li>
          <li>
            <strong>Exercise Analysis Data</strong>: Metrics and analysis
            generated when our AI evaluates your exercise form.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>Analyze and provide feedback on your exercise form</li>
          ...
          <li>
            Detect, investigate, and prevent security incidents and fraudulent
            transactions
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Your content, including videos, is stored using secure cloud storage
          solutions. Exercise analysis data is processed through our AI system
          and stored securely for future reference and to improve your
          experience.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Service Providers</strong>: Companies that perform services
            on our behalf, such as cloud storage, data analysis, email delivery,
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Withdrawing consent at any time, where we rely on consent to process
            your information
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          data protection laws that are different from those in your country. We
      ...
      <p className="mt-12 text-center text-gray-400">
        Thank you for trusting FormCoachAI with your fitness journey.
      </p>
    </div>
  );
}
